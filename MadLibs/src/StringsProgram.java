...
public class StringsProgram {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nThe Mad Inventor\n(story idea from Funny Fill-in National Geographic Kids)\n");
		...
		System.out.println("And one more plural noun: ");
		...
		System.out.println("Enter something slimy: ");
		...
		System.out.println("\nI was going to be rich! I had just invented the first \nelectric " + word1 + ". Using a(n) " + word2 + " from " + word3 + "’s \ntoolbox, I built it out of old " + word4 + ", metal " + word5 + ", \nand rubber " + word6 + ". The first time I turned it on, the \nmachine worked " + word7 + ". I couldn’t believe \nit! \""+ word8 + "!\" I yelled, " + word9 + " up and down. I invited \na(n) " + word10 + " billionaire to check out my invention. I couldn’t \nwait to sell it for " + word11 + " million dollars and live \nlike " + word12 + ". But when I turned it on, something went \nterribly " + word13 + ". The machine started " + word14 + " and \nbegan to " + word15 + ". Suddenly it spewed " + word16 + " and shot \nslices of " + word17 + " in all directions. The billionaire \nstarted screaming at the top of his " + word18 + " and " + word19 + " \nout of my lab. Good thing I still get my weekly allowance.\r\n");
